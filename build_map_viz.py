...
const SECTOR_COLORS = {
  'Health and Family Welfare': { fill: '#e11d48', stroke: '#be123c', text: '#9f1239', bg: '#ffe4e6', name: 'Health & Family Welfare' },
  ...
  'Finance': { fill: '#d97706', stroke: '#b45309', text: '#78350f', bg: '#fef3c7', name: 'Finance & Economy' },
  'Environment, Forest and Climate Change': { fill: '#65a30d', stroke: '#4d7c0f', text: '#365314', bg: '#ecfccb', name: 'Environment & Climate' },
  'Women and Child Development': { fill: '#db2777', stroke: '#be185d', text: '#831843', bg: '#fce7f3', name: 'Women & Child Dev' },
  'Education': { fill: '#7c3aed', stroke: '#6d28d9', text: '#4c1d95', bg: '#ede9fe', name: 'Education' },
  'AYUSH': { fill: '#0891b2', stroke: '#0e7490', text: '#155e75', bg: '#cffafe', name: 'AYUSH' },
  'Home Affairs': { fill: '#475569', stroke: '#334155', text: '#0f172a', bg: '#f1f5f9', name: 'Home Affairs & Security' },
  'Road Transport and Highways': { fill: '#ea580c', stroke: '#c2410c', text: '#7c2d12', bg: '#ffedd5', name: 'Road Transport & Highways' },
  'Jal Shakti': { fill: '#0284c7', stroke: '#0369a1', text: '#075985', bg: '#e0f2fe', name: 'Jal Shakti (Water Resources)' },
  'Rural Development': { fill: '#b45309', stroke: '#92400e', text: '#78350f', bg: '#fef3c7', name: 'Rural Development' },
  'Commerce and Industry': { fill: '#ca8a04', stroke: '#a16207', text: '#713f12', bg: '#fef9c3', name: 'Commerce & Industry' },
  'Housing and Urban Affairs': { fill: '#0d9488', stroke: '#0f766e', text: '#115e59', bg: '#ccfbf1', name: 'Housing & Urban Affairs' },
  'Petroleum and Natural Gas': { fill: '#991b1b', stroke: '#7f1d1d', text: '#450a0a', bg: '#fee2e2', name: 'Petroleum & Gas' },
  'Civil Aviation': { fill: '#06b6d4', stroke: '#0891b2', text: '#164e63', bg: '#cffafe', name: 'Civil Aviation' },
  'Textiles': { fill: '#c026d3', stroke: '#a21caf', text: '#701a75', bg: '#fae8ff', name: 'Textiles' },
  'Consumer Affairs, Food and Public Distribution': { fill: '#eab308', stroke: '#ca8a04', text: '#713f12', bg: '#fef9c3', name: 'Consumer Affairs & Food' },
  'Labour and Employment': { fill: '#4d7c0f', stroke: '#3f6212', text: '#1a2e05', bg: '#f7fee7', name: 'Labour & Employment' },
  'Communications': { fill: '#4f46e5', stroke: '#4338ca', text: '#312e81', bg: '#e0e7ff', name: 'Communications (IT/Telecom)' }
};
...
print(f"Generated Proportional Bubble Map with Full 20 Sectors in Right Panel: {len(HTML_FINAL)//1024} KB")
